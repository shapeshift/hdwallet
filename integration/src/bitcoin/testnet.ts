...
export function testnetTests (get: () => {wallet: HDWallet, info: HDWalletInfo}): void {
  ...
  describe('Testnet', () => {
    ...
    beforeEach(async () => {
      if (!wallet) return
      await wallet.wipe()
      await wallet.loadDevice({ mnemonic: MNEMONIC12_ALLALL, label: 'test', skipChecksum: true })
    }, TIMEOUT)
    ...
    test('btcSignTx() - p2sh-p2pkh', async () => {
      ...
      expect(res.serializedTx).toEqual("")
    }, TIMEOUT)
    ...
    test('btcSignTx() - p2wpkh', async () => {
      ...
      expect(res.serializedTx).toEqual("")
    })
