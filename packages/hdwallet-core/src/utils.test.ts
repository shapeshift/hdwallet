...
describe("toHexString", () => {
  test.each([
    ...
    "123456",
    "abcdef"
  ])('toHexString(fromHexString("%s")) == "%s"', (str) => {
...
describe("bip32ToAddressNList", () => {
  ...
  it.each([
    "///",
    "m/2147483692'/0'/0'/0/0",
    "ceci n'est pas une bip32 path"
  ])("to throw on invalid input: '%s'", (str) => {
    expect(() => { bip32ToAddressNList(str) }).toThrow()
  })
})
