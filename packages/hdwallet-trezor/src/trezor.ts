...
// Special non-BIP-44 path descriptions for Trezor.
function ethDescribeTrezorPath(path: core.BIP32Path): core.PathDescription {
...
export class TrezorHDWalletInfo implements core.HDWalletInfo, core.BTCWalletInfo, core.ETHWalletInfo {
  ...
  public describePath(msg: core.DescribePath): core.PathDescription {
    if (msg.coin.toLowerCase() === "ethereum") return ethDescribeTrezorPath(msg.path);
