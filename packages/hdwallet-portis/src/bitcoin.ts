...
export function describeUTXOPath(path: core.BIP32Path, coin: core.Coin, scriptType?: core.BTCScriptType): core.PathDescription {
  ...
  } as Partial<Record<core.BTCScriptType, string[]>>)[scriptType] ?? [] as string[] : [] as string[];
