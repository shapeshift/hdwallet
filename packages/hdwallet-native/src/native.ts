...
export class NativeHDWallet
  ...
  implements core.HDWallet, core.BTCWallet, core.ETHWalletEIP1559, core.CosmosWallet, core.FioWallet, core.ThorchainWallet, core.SecretWallet, core.TerraWallet, core.KavaWallet {
