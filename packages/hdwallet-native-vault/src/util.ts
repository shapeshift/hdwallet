...
export async function createMnemonicServer(mnemonic: nativeType.crypto.Isolation.Core.BIP39.Mnemonic) {
  return (await nativeEngines).Remote.BIP39.MnemonicServer.create(mnemonic)
}
