...
describe("overlay", () => {
  it("works", async () => {
    const obj = core.overlay({ foo: "bar", bar: "baz" }, { baz: "bash" });
  ...
  it("works with an upper prototype", async () => {
    const obj = core.overlay({ foo: "bar" }, Object.assign(Object.create({ baz: "bash" }), {
      bar: "baz",
    }));
    expect(obj.foo).toEqual("bar");
    expect(obj.bar).toEqual("baz");
  ...
  it("works with an lower prototype", async () => {
    const obj = core.overlay(Object.assign(Object.create({ foo: "bar" }), {
      bar: "baz",
    }), { baz: "bash" });
    expect(obj.foo).toEqual("bar");
    expect(obj.bar).toEqual("baz");
