...
import { BitBox02Adapter } from '@shapeshiftoss/hdwallet-bitbox02'
...
const bitbox02Adapter = BitBox02Adapter.useKeyring(keyring)
...
$bitbox02.on('click', async (e) => {
  e.preventDefault()
  wallet = await bitbox02Adapter.pairDevice()
  //listen(wallet.transport)
  window['wallet'] = wallet
...
(async () => {
  ...
  try {
    await bitbox02Adapter.initialize(undefined, /*autoConnect=*/false)
  } catch (e) {
    console.error('Could not initialize BitBox02Adapter', e)
  }
